...
public class BudgetFormActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        BudgetNav.openBudgetsHome(BudgetFormActivity.this);
    }
    ...
    public void budgetDataBaseRegistrationService(){
        ...
        budgetRegExecService.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                budgetRegDialog.setNegativeButton(getString(R.string.back), (dialog, which) -> BudgetNav.openBudgetsHome(BudgetFormActivity.this));
