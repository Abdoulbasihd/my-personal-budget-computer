...
import cm.abimmobiledev.mybudgetizer.nav.Navigator;
...
public class MainMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainMenuBinding.cardAccountManager.setOnClickListener(aboutView -> Navigator.openAccountBoard(MainMenuActivity.this, accountName, currency));
